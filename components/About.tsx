...
export default function About() {
  return (
    <div>
      ...
      <section className="flex flex-col bg-primary/15 dark:bg-accent w-full items-center justify-center p-8">
      ...
      <section className=" flex flex-col bg-primary/15 dark:bg-accent w-full items-center justify-center my-14 text-sm md:text-base px-4">
